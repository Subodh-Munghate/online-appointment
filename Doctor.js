...
var doctors = [
    ...
    { name: 'Dr. David Brown', specialty: 'Physiatrists', location: 'Mumbai', bio: 'Dr. David Brown is a physiatrist focusing on physical medicine and rehabilitation.' },
    ...
    { name: 'Dr. Christopher Davis', specialty: 'General Practitioner', location: 'Mumbai', bio: 'Dr. Christopher Davis is a cardiologist specializing in heart diseases and cardiovascular care.' },
    { name: 'Dr. Olivia Garcia', specialty: 'Plastic Surgeons', location: 'Mumbai', bio: 'Dr. Olivia Garcia is a pediatrician committed to providing quality healthcare for children.' },
    { name: 'Dr. Ethan Martinez', specialty: 'Physiatrists', location: 'Chennai', bio: 'Dr. Ethan Martinez is an endocrinologist focusing on hormonal disorders and diabetes management.' },
    { name: 'Dr. Ava Thompson', specialty: 'General Practitioner', location: 'Pune', bio: 'Dr. Ava Thompson is a rheumatologist specializing in the treatment of rheumatic diseases.' },
    ...
    { name: 'Dr. Benjamin White', specialty: 'Urologists', location: 'Chennai', bio: 'Dr. Benjamin White is an allergist offering expert care for allergies and immunological disorders.' },
    ...
    { name: 'Dr. Ava Wilson', specialty: 'General Practitioner', location: 'Delhi', bio: 'Dr. Ava Wilson is a rheumatologist specializing in the diagnosis and treatment of rheumatic diseases.' },
    { name: 'Dr. Liam Taylor', specialty: 'Ophthalmologists', location: 'Mumbai', bio: 'Dr. Liam Taylor is an ophthalmologist specializing in eye surgeries and treatments.' },
    ...
    { name: 'Dr. Lily Brown', specialty: 'Physiatrists', location: 'Nagpur', bio: 'Dr. Lily Brown is an endocrinologist specializing in hormonal disorders and diabetes management.' },
    { name: 'Dr. Benjamin Garcia', specialty: 'Plastic Surgeons', location: 'Nagpur', bio: 'Dr. Benjamin Garcia is a pediatrician providing care for children and adolescents.' },
    { name: 'Dr. Ella Wilson', specialty: 'Dermatologists', location: 'Chennai', bio: 'Dr. Ella Wilson is a dermatologist specializing in skin conditions and treatments.' },
    { name: 'Dr. Ethan Clark', specialty: 'General Practitioner', location: 'Mumbai', bio: 'Dr. Ethan Clark is a cardiologist specializing in heart diseases and cardiovascular care.' },
    ...
    { name: 'Dr. Lucas White', specialty: 'Oncologists', location: 'Mumbai', bio: 'Dr. Lucas White is an oncologist specializing in cancer diagnosis and treatment.' },
    ...
    { name: 'Dr. Benjamin Wilson', specialty: 'General Practitioner', location: 'Delhi', bio: 'Dr. Benjamin Wilson is a rheumatologist specializing in the diagnosis and treatment of rheumatic diseases.' },
    { name: 'Dr. Ella Clark', specialty: 'Ophthalmologists', location: 'Delhi', bio: 'Dr. Ella Clark is an ophthalmologist specializing in eye surgeries and treatments.' },
    { name: 'Dr. Ethan Taylor', specialty: 'Urologists', location: 'Pune', bio: 'Dr. Ethan Taylor is a urologist providing care for urinary tract disorders and conditions.' },
    { name: 'Dr. Mia Brown', specialty: 'Gynecologists', location: 'Mumbai', bio: 'Dr. Mia Brown is a gynecologist offering comprehensive women\'s healthcare services.' },
    { name: 'Dr. Lucas Martinez', specialty: 'Physiatrists', location: 'Pune', bio: 'Dr. Lucas Martinez is an endocrinologist specializing in hormonal disorders and diabetes management.' },
    { name: 'Dr. Ava White', specialty: 'Plastic Surgeons', location: 'Chennai', bio: 'Dr. Ava White is a pediatrician providing care for children and adolescents.' },
    ...
    { name: 'Dr. Emma Clark', specialty: 'General Practitioner', location: 'Chennai', bio: 'Dr. Emma Clark is a cardiologist specializing in heart diseases and cardiovascular care.' },
    ...
    { name: 'Dr. Lily White', specialty: 'Oncologists', location: 'Delhi', bio: 'Dr. Lily White is an oncologist specializing in cancer diagnosis and treatment.' },
    { name: 'Dr. Benjamin Brown', specialty: 'Gastroenterologists', location: 'Mumbai', bio: 'Dr. Benjamin Brown is a gastroenterologist providing care for gastrointestinal disorders and diseases.' },
    ...
    { name: 'Dr. Ava White', specialty: 'General Practitioner', location: 'Chandrapur', bio: 'Dr. Ava White is a rheumatologist specializing in the diagnosis and treatment of rheumatic diseases.' },
    ...
    { name: 'Dr. Emma Taylor', specialty: 'Urologists', location: 'hyderabad', bio: 'Dr. Emma Taylor is a urologist providing care for urinary tract disorders and conditions.' },
    { name: 'Dr. Noah Brown', specialty: 'Gynecologists', location: 'Pune', bio: 'Dr. Noah Brown is a gynecologist offering comprehensive women\'s healthcare services.' },
    { name: 'Dr. Lily Martinez', specialty: 'Physiatrists', location: 'hyderabad', bio: 'Dr. Lily Martinez is an endocrinologist specializing in hormonal disorders and diabetes management.' },
    { name: 'Dr. Benjamin Wilson', specialty: 'Plastic Surgeons', location: 'Pune', bio: 'Dr. Benjamin Wilson is a pediatrician providing care for children and adolescents.' },
    { name: 'Dr. Ella Clark', specialty: 'Dermatologists', location: 'Nagpur', bio: 'Dr. Ella Clark is a dermatologist specializing in skin conditions and treatments.' },
    { name: 'Dr. Ethan Taylor', specialty: 'General Practitioner', location: 'Nagpur', bio: 'Dr. Ethan Taylor is a cardiologist specializing in heart diseases and cardiovascular care.' },
    { name: 'Dr. Mia Martinez', specialty: 'Orthopedic Surgeons', location: 'Chennai', bio: 'Dr. Mia Martinez is an orthopedic surgeon providing surgical and non-surgical care for orthopedic conditions.' },
    { name: 'Dr. Lucas White', specialty: 'Oncologists', location: 'Chennai', bio: 'Dr. Lucas White is an oncologist specializing in cancer diagnosis and treatment.' },
    { name: 'Dr. Ava Garcia', specialty: 'Gastroenterologists', location: 'Nagpur', bio: 'Dr. Ava Garcia is a gastroenterologist providing care for gastrointestinal disorders and diseases.' },
    { name: 'Dr. Liam Brown', specialty: 'Nephrologists', location: 'Akola', bio: 'Dr. Liam Brown is a nephrologist specializing in kidney diseases and renal care.' },
    { name: 'Dr. Emma Taylor', specialty: 'Otolaryngologists', location: 'Mumbai', bio: 'Dr. Emma Taylor is an otolaryngologist specializing in ear, nose, and throat disorders.' },
    { name: 'Dr. Noah Johnson', specialty: 'Neonatologists', location: 'Chennai', bio: 'Dr. Noah Johnson is a neonatologist specializing in the care of newborn infants.' },
    { name: 'Dr. Lily Martinez', specialty: 'Geriatricians', location: 'Pune', bio: 'Dr. Lily Martinez is a geriatrician providing care for elderly patients.' },
    ...
    { name: 'Dr. Ethan Taylor', specialty: 'Urologists', location: 'Nagpur', bio: 'Dr. Ethan Taylor is a urologist providing care for urinary tract disorders and conditions.' },
    { name: 'Dr. Mia Brown', specialty: 'Gynecologists', location: 'Akola', bio: 'Dr. Mia Brown is a gynecologist offering comprehensive women\'s healthcare services.' },
    { name: 'Dr. Lucas Martinez', specialty: 'Physiatrists', location: 'Mumbai', bio: 'Dr. Lucas Martinez is an endocrinologist specializing in hormonal disorders and diabetes management.' },
    { name: 'Dr. Ava White', specialty: 'Plastic Surgeons', location: 'Mumbai', bio: 'Dr. Ava White is a pediatrician providing care for children and adolescents.' },
    { name: 'Dr. Liam Clark', specialty: 'Dermatologists', location: 'hyderaabad', bio: 'Dr. Liam Clark is a dermatologist specializing in skin conditions and treatments.' },
    { name: 'Dr. Emma Taylor', specialty: 'General Practitioner', location: 'Chandrapur', bio: 'Dr. Emma Taylor is a cardiologist specializing in heart diseases and cardiovascular care.' },
    { name: 'Dr. Noah Martinez', specialty: 'Orthopedic Surgeons', location: 'Chennai', bio: 'Dr. Noah Martinez is an orthopedic surgeon providing surgical and non-surgical care for orthopedic conditions.' },
    { name: 'Dr. Lily White', specialty: 'Oncologists', location: 'hyderabaad', bio: 'Dr. Lily White is an oncologist specializing in cancer diagnosis and treatment.' },
    { name: 'Dr. Benjamin Brown', specialty: 'Gastroenterologists', location: 'Chandrapur', bio: 'Dr. Benjamin Brown is a gastroenterologist providing care for gastrointestinal disorders and diseases.' },
    { name: 'Dr. Ella Garcia', specialty: 'Nephrologists', location: 'Akola', bio: 'Dr. Ella Garcia is a nephrologist specializing in kidney diseases and renal care.' },
    { name: 'Dr. Ethan Wilson', specialty: 'Otolaryngologists', location: 'Mumbai', bio: 'Dr. Ethan Wilson is an otolaryngologist specializing in ear, nose, and throat disorders.' },
    { name: 'Dr. Mia Clark', specialty: 'Neonatologists', location: 'Chennai', bio: 'Dr. Mia Clark is a neonatologist specializing in the care of newborn infants.' },
    { name: 'Dr. Lucas Martinez', specialty: 'Geriatricians', location: 'Pune', bio: 'Dr. Lucas Martinez is a geriatrician providing care for elderly patients.' },
    { name: 'Dr. Ava White', specialty: 'General Practitioner', location: 'Delhi', bio: 'Dr. Ava White is a rheumatologist specializing in the diagnosis and treatment of rheumatic diseases.' },
    { name: 'Dr. Liam Clark', specialty: 'Ophthalmologists', location: 'Akola', bio: 'Dr. Liam Clark is an ophthalmologist specializing in eye surgeries and treatments.' },
    { name: 'Dr. Emma Taylor', specialty: 'Urologists', location: 'Delhi', bio: 'Dr. Emma Taylor is a urologist providing care for urinary tract disorders and conditions.' },
    { name: 'Dr. Noah Brown', specialty: 'Gynecologists', location: 'Chandrapur', bio: 'Dr. Noah Brown is a gynecologist offering comprehensive women\'s healthcare services.' },
    { name: 'Dr. Lily Martinez', specialty: 'Physiatrists', location: 'Akola', bio: 'Dr. Lily Martinez is an endocrinologist specializing in hormonal disorders and diabetes management.' },
    { name: 'Dr. Benjamin Wilson', specialty: 'Plastic Surgeons', location: 'Delhi', bio: 'Dr. Benjamin Wilson is a pediatrician providing care for children and adolescents.' }
    // Add more doctors as needed
];
